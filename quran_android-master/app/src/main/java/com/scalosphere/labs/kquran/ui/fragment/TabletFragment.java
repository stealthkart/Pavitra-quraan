...
import com.scalosphere.labs.kquran.task.QueryAyahCoordsTask;
import com.scalosphere.labs.kquran.task.QueryBookmarkedAyahsTask;
import com.scalosphere.labs.kquran.task.QueryPageCoordsTask;
...
import com.scalosphere.labs.kquran.ui.util.ImageAyahUtils;
...
public class TabletFragment extends SherlockFragment implements AyahTracker {
  ...
  private class GetAyahCoordsTask extends QueryAyahCoordsTask {
    ...
    public GetAyahCoordsTask(Context context, MotionEvent event, AyahSelectedListener.EventType eventType, int page) {
  ...
  private class PageGestureDetector extends GestureDetector.SimpleOnGestureListener {
    ...
    public boolean onSingleTapUp(MotionEvent event) {
      return handleEvent(event, AyahSelectedListener.EventType.SINGLE_TAP);
    }

    @Override
    public boolean onDoubleTap(MotionEvent event) {
      unHighlightAyahs(HighlightType.SELECTION);
      return handleEvent(event, AyahSelectedListener.EventType.DOUBLE_TAP);
    }

    @Override
    public void onLongPress(MotionEvent event) {
      handleEvent(event, AyahSelectedListener.EventType.LONG_PRESS);
    }

    private boolean checkCoordinateData(MotionEvent event, AyahSelectedListener.EventType eventType) {
    ...
    private boolean handleEvent(MotionEvent event, AyahSelectedListener.EventType eventType) {
  ...
  public void highlightAyah(int sura, int ayah, HighlightType type) {
      //TODO remove the below code if the soorah/aayah transition from the main listing page doesn't work as expected.
/*      if(type==HighlightType.BLACK){
  ...
  private void handlePress(MotionEvent event, AyahSelectedListener.EventType eventType, int page) {
