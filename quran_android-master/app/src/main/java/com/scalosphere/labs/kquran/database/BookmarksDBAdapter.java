...
import com.scalosphere.labs.kquran.database.BookmarksDBHelper.BookmarkTagTable;
import com.scalosphere.labs.kquran.database.BookmarksDBHelper.BookmarksTable;
import com.scalosphere.labs.kquran.database.BookmarksDBHelper.TagsTable;
  ...
  public List<Bookmark> getBookmarkedAyahsOnPage(int page) {
   ...
   public void tagBookmarks(long[] bookmarkIds, List<Tag> tags) {
      ...
      try {
         ...
         Log.e(TAG, "exception in tagBookmark", e);
      }
