...
public class QuranDataProvider extends ContentProvider {
  private static final String TAG =
	...
	public static String AUTHORITY =
		"com.scalosphere.labs.kquran.data.QuranDataProvider";
	public static final Uri
		SEARCH_URI = Uri.parse("content://" + AUTHORITY +  "/quran/search");

	 public static final String VERSES_MIME_TYPE = 
		 ContentResolver.CURSOR_DIR_BASE_TYPE +
		 "/vnd.com.scalosphere.labs.kquran"; //TODO fix it
	 public static final String AYAH_MIME_TYPE =
		 ContentResolver.CURSOR_ITEM_BASE_TYPE +
          "/vnd.com.scalosphere.labs.kquran";
	 public static final String QURAN_ARABIC_DATABASE = "quran.ar.db";
    //commented on 09-12-2014
     //public static final String QURAN_KAN_DATABASE = "db/quran.kan.hamzah.db";
    public static final String QURAN_KAN_DATABASE = "quran.kan.hamzah.db";
   ...
   private SharedPreferences mPrefs = null;
	...
	public Cursor query(Uri uri, String[] projection, String selection,
        ...
        //Log.i(TAG,"uri: " + uri.toString() + " sURIMatcher "+ sURIMatcher);
			...
			if (suggestions.moveToFirst()){
				do {
					...
					String foundText = context
                       ...
                       " " + QuranInfo.getSuraNameOnly(context, sura, false) +
	...
	private Cursor search(String query, String language, boolean wantSnippets) {
		//Log.i(TAG, "q: " + query + ", l: " + language + " mCurrentLanguage "+mCurrentLanguage);
       ...
       //Log.i(TAG, " mCurrentLanguage "+mCurrentLanguage +" language  "+ language);
      }
